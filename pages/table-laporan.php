...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Tabel Laporan | Admin</title>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">Total Susut</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $kategori = mysqli_query($mysqli,"SELECT detail_susut.id_detail,tb_kategori.nm_katagori,tb_asset.nama_asset,tb_asset.qty,tb_asset.tgl_perolehan,tb_asset.hrg_perolehan,tb_asset.umur_ekonomis,tb_asset.nilai_sisa,tb_penyusutan.total_penyusutan FROM tb_kategori JOIN tb_asset ON tb_kategori.id_kategori = tb_asset.id_asset JOIN tb_penyusutan ON tb_asset.id_asset = tb_penyusutan.id_penyusutan JOIN detail_susut ON tb_penyusutan.id_penyusutan = detail_susut.id_detail");
                                                $no = 1;
                                                if($kategori){
